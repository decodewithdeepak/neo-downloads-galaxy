    ...
    <header className={cn("w-full py-6 px-4 md:px-8", className)}>
      <div className="container flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-xl font-semibold text-neogray-900">neotube</h1>
        </div>
        
        <nav className="hidden md:flex items-center space-x-6">
          <a href="#" className="text-neogray-700 hover:text-neoblue-500 transition-colors">Home</a>
          <a href="#history" className="text-neogray-700 hover:text-neoblue-500 transition-colors">History</a>
          <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-neogray-700 hover:text-neoblue-500 transition-colors">GitHub</a>
        </nav>
        ...
        <a
          ...
          className="neo-button-secondary text-sm hidden md:flex"
        >
          <svg
            width="20"
            height="20"
